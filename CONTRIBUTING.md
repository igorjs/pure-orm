...
```bash
git clone https://github.com/igorjs/pure-orm.git
cd pure-orm
pnpm install
```
...
```
feat(query): add window function support
fix(connection): handle pool exhaustion gracefully
